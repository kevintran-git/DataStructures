 ...
 */
public class BookHashedDictionary<K, V> implements DictionaryInterface<K, V>
{
    // The dictionary:
    ...
    public BookHashedDictionary()
    {
        this(DEFAULT_CAPACITY); // Call next constructor
    } // end default constructor

    public BookHashedDictionary(int initialCapacity)
    {
...
///      locationsUsed = 0;
     ...
     * and resolves it by following a probe sequence.
     * @param index
     * @param key
