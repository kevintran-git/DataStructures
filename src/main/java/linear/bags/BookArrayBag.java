...
/**
 ...
 @version 5.0
 */
public final class BookArrayBag<T> implements BagInterface<T>
{
    private final T[] bag;
    ...
    public BookArrayBag(int desiredCapacity)
    {
    ...
    public Iterator<T> iterator() {
        return Arrays.stream(bag).filter(Objects::nonNull).iterator();
    }
} // end ArrayBag
