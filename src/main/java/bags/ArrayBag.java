...
public final class ArrayBag<T> implements BagInterface<T>
{
    ...
    public void clear() //EXERCISE 3
    {
        checkIntegrity(); //integrity check
        int size = bag.length;
        bag = (T[])new Object[size];
        numberOfEntries = 0; // Replaces bag with an empty bag, O(1) time instead of O(n)
    } // end clear
    ...
    {
        checkIntegrity();
        T result = removeEntry(numberOfEntries - 1); //EXERCISE 4: Replace givenIndex here with Math.random()*numberofEntries. This would no longer affect any method.
        return result;
    } // end remove
